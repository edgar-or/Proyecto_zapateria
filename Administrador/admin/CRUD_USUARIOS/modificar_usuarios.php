...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt_update->execute()) {
        echo "<script>alert('Se modifico correctamente');Window.location.href='modificar_usuarios.php';</script>";
    } else {
        echo "<script>alert('Ocurrio un eror intenta nuevamente');Window.location.href='modificar_usuarios.php';</script>";
    }
}
            ...
            <div class="col-md-5">
                ...
                <form method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="primer_nombre" name="primer_nombre" value="<?php echo $usuario['primer_nombre']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="primer_apellido" class="col-sm-4 col-form-label">Primer Apellido</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="primer_apellido" name="primer_apellido" value="<?php echo $usuario['primer_apellido']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="tipo_usuario" class="col-sm-4 col-form-label">Tipo de Usuario</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="tipo_usuario" name="tipo_usuario" value="<?php echo $usuario['tipo_usuario']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="telefono_usuario" class="col-sm-4 col-form-label">Teléfono</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="telefono_usuario" name="telefono_usuario" value="<?php echo $usuario['telefono_usuario']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="correo_usuario" class="col-sm-4 col-form-label">Correo Electrónico</label>
                        <div class="col-sm-8">
                            <input type="email" class="form-control" id="correo_usuario" name="correo_usuario" value="<?php echo $usuario['correo_usuario']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="nick_name" class="col-sm-4 col-form-label">Nickname</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="nick_name" name="nick_name" value="<?php echo $usuario['nick_name']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-dark me-2">Guardar Cambios</button>
